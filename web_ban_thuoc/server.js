...
const connection = mysql.createConnection({
    host: '127.0.0.1', 
    user: 'root',      // Đổi thành 'root' vì thường là user mặc định có quyền cao nhất
    password: '',      // Để trống nếu dùng XAMPP mặc định, hoặc điền pass của bạn
    database: 'webhieuthuoc'
});
...
app.listen(PORT, '0.0.0.0', () => {
    console.log('--------------------------------------------------');
    console.log(`Server Nam Nguyễn Pharma chạy tại: http://localhost:${PORT}`);
    console.log('--------------------------------------------------');
});